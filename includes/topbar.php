...
<html lang="en">
    <head>
        ...
        <title>UP-RESULT Software| Dashboard</title>
            	...
            	<div class="container-fluid">
                    <div class="row">
                        <div class="navbar-header no-padding">
                			<a class="navbar-brand" target="a_blank" href="https://www.mayurik.com">
                		...
                		<div class="collapse navbar-collapse" id="navbar-collapse-1">
                			<ul class="nav navbar-nav" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                ...
                                <!-- <li style="color: red;"><marquee behavior="scroll" scrollamount="3"><strong>  Alert : Don't Sale or Publish this script with your name. However you can use it for Academic study Purpose !</strong></marquee></li> -->
                			</ul>
                            <!-- /.nav navbar-nav -->
