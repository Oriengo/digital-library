	...
	<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
		...
		<ul class="nav flex-column">
			...
			<li class="nav-item">
				<a class="nav-link" href="../teacher/teacher-personal-information.php">
					<span data-feather="file"></span>
					<i class="fa fa-info-circle mr-2" aria-hidden="true"></i> Set Work-study
				</a>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link" href="../teacher/teacher-personal-information.php">
					<span data-feather="file"></span>
					<i class="fa fa-info-circle mr-2" aria-hidden="true"></i> Set Bursary Applicant
				</a>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link" href="../teacher/student-attendance.php">
					<span data-feather="users"></span>
					<i class="fa fa-check-circle mr-2" aria-hidden="true"></i> Set Candidates
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="../teacher/student-attendance.php">
					<span data-feather="users"></span>
					<i class="fa fa-check-circle mr-2" aria-hidden="true"></i>Library services
				</a>
			</li>
			<li class="nav-item">
