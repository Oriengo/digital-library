...
<body>
	...
	<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
		...
		<button class="bg-success p-3 text white"><a class='text-white' href="sms.php">Remind Overdue</a></button>
		<button class="bg-success p-3"><a class='text-white' href="sms2.php">Remind all</a></button>
		<script>
