...
$query = "SELECT phone_number, first_name FROM student_information INNER JOIN borrowing_tbl ON borrowing_tbl.reg_number = student_information.reg_number WHERE borrowing_tbl.comments = 'Not yet returned'";
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $message[] = "Dear $name, Kisii University digital library request you to return your borrowed boook today.";
    // }
    // var_dump($recipients);
    // var_dump($name);
}
