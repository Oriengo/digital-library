...
<table class="w-10 table-elements mb-3 table-three-tr text-left">
    <thead>
...
<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 mb-2 w-100">
                ...
                <thead>
                    <tr>
                        <div class="text-danger text-center m-auto">
                            ...
                            <h5 class="text-dark mt-3">KISUMU UNIVERSITY - KSU</h5>
                    </tr>
                </thead>

                <?php
                $reg_number = $_SESSION['LoginStudent'];
                $query = "SELECT * FROM student_information INNER JOIN programmes ON programmes.programme_code = student_information.programme_code INNER JOIN schools ON schools.school_code = student_information.school_code  WHERE reg_number = '$reg_number'";
                $run = mysqli_query($con, $query);
                while ($row = mysqli_fetch_array($run)) { ?>
                    <h4 class="text-dark"> <?php echo $row['school_name']; ?></h4>
                <?php }
                ?>
        </div>
    </div>
    <div class="container-fluid mb-4 text-dark">
        <div class="program-info">
            <?php
            $reg_number = $_SESSION['LoginStudent'];
            $query = "SELECT * FROM student_information INNER JOIN programmes ON programmes.programme_code = student_information.programme_code  where reg_number = '$reg_number'";
            $run = mysqli_query($con, $query);
            while ($row = mysqli_fetch_array($run)) { ?>
                <h5>Student Transcript - <?php echo $row['programme_name']; ?> Program</h5>
        </div>
        <div class="d-flex mt-3">
            <div>
                <h5>Student Name : <?php echo $row['first_name'] . " " . $row['middle_name'] . " " . $row['last_name']; ?></h5>
                <h5>Parent/Guardian : <?php echo $row['father_name']; ?></h5>
            </div>
            <div class="ml-auto">
                <h4>Student I.D : <?php echo $row['reg_number']; ?></h4>
                <h4>Year of Addmission : <?php echo intval($row['registration_date'])  ?></h4>
            </div>
        </div>
    <?php }
    ?>
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "SELECT * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='1' and sc.reg_number='$reg_number'";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        $result_query = "select * from class_result cr inner join student_courses cs on cr.subject_code = cs.subject_code and cr.reg_number=cs.reg_number where cr.subject_code='$subject' and cr.reg_number='$reg_number'";
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='2' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='3' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='4' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='5' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='6' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='7' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='8' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='9' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
                    ...
                    <section class="mt-3">
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr" cellpadding="2">
                                <tr class="pt-5 table-six text-white" style="height: 32px;">
                                    <?php
                                    $que = "select * from student_courses sc inner join sessions s on sc.session = s.session_id where sc.semester='10' and sc.reg_number='$reg_number'";
                                    $run = mysqli_query($con, $que);
                                    while ($row = mysqli_fetch_array($run)) {
                                        $session = $row['session_name'];
                                        $assign_date = date("Y", strtotime($row['assign_date']));;
